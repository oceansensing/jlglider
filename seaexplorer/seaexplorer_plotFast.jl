...
htemp = Plots.plot(sea064pld1d.t[tind], sea064pld1d.z[tind], zcolor = sea064pld1d.ctemp[tind], seriestype=:scatter, seriescolor=:harpercm, markersize = ms, markerstrokewidth = 0, legend = false, label="", clims=lims_temp, colorbar = true, size=ps, dpi=300, framestyle=:box, title="Conservative Temperature");
#Plots.contour!(sea064pld1d.t, sea064pld1d.z, sigma0);
hsalt = Plots.plot(sea064pld1d.t[tind], sea064pld1d.z[tind], zcolor = sea064pld1d.saltA[tind], seriestype=:scatter, c=:haline, markersize = ms, markerstrokewidth = 0, legend = false, label="", clims=lims_salt, colorbar = true, size=ps, dpi=300, framestyle=:box, title="Absolute Salinity")
hsigma0 = Plots.plot(sea064pld1d.t[tind], sea064pld1d.z[tind], zcolor = sea064pld1d.sigma0[tind], seriestype=:scatter, c=:dense, markersize = ms, markerstrokewidth = 0, legend = false, label="", clims=lims_sigma0, colorbar = true, size=ps, dpi=300, framestyle=:box, title="Potential Density Anomaly")
hspice0 = Plots.plot(sea064pld1d.t[tind], sea064pld1d.z[tind], zcolor = sea064pld1d.spice0[tind], seriestype=:scatter, c=:hsv, markersize = ms, markerstrokewidth = 0, legend = false, label="", clims=lims_spice0, colorbar = true, size=ps, dpi=300, framestyle=:box, title="Spiciness")
hsndspd = Plots.plot(sea064pld1d.t[tind], sea064pld1d.z[tind], zcolor = sea064pld1d.sndspd[tind], seriestype=:scatter, c=:jet1, markersize = ms, markerstrokewidth = 0, legend = false, label="", clims=lims_sndspd, colorbar = true, size=ps, dpi=300, framestyle=:box, title="Sound Speed")
hUeast = Plots.plot(sea064pld1d.t[tind], sea064pld1d.z[tind], zcolor = sea064pld1d.ad2cp_Ueast[tind], seriestype=:scatter, c=:vik, markersize = ms, markerstrokewidth = 0, legend = false, label="", clims=lims_uv, colorbar = true, size=ps, dpi=300, framestyle=:box, title="U: E-W Velocity")
hUnorth = Plots.plot(sea064pld1d.t[tind], sea064pld1d.z[tind], zcolor = sea064pld1d.ad2cp_Unorth[tind], seriestype=:scatter, c=:vik, markersize = ms, markerstrokewidth = 0, legend = false, label="", clims=lims_uv, colorbar = true, size=ps, dpi=300, framestyle=:box, title="V: N-S Velocity")

hN2 = Plots.plot(sea064pld1d.tmid[tindmid], sea064pld1d.zmid[tindmid], zcolor = sea064pld1d.n2[tindmid], seriestype=:scatter, c=:jet1, markersize = ms, markerstrokewidth = 0, legend = false, label="", clims=lims_n2, colorbar = true, size=ps, dpi=300, framestyle=:box, title="N^2")
hMReps1 = Plots.plot(sea064pld1d.t[tind], sea064pld1d.z[tind], zcolor = log10.(sea064pld1d.mr_eps1[tind]), seriestype=:scatter, c=:harpercm, markersize = ms, markerstrokewidth = 0, legend = false, label="", clims=lims_epsilon, colorbar = true, size=ps, dpi=300, framestyle=:box, title="TKE Dissipation: Shear 1")
hMReps2 = Plots.plot(sea064pld1d.t[tind], sea064pld1d.z[tind], zcolor = log10.(sea064pld1d.mr_eps2[tind]), seriestype=:scatter, c=:jet, markersize = ms, markerstrokewidth = 0, legend = false, label="", clims=lims_epsilon, colorbar = true, size=ps, dpi=300, framestyle=:box, title="TKE Dissipation: Shear 2")
...
hMRsh1std = Plots.plot(sea064pld1d.t[tind], sea064pld1d.z[tind], zcolor = log10.(sea064pld1d.mr_sh1_std[tind]), seriestype=:scatter, c=:jet, markersize = ms, markerstrokewidth = 0, legend = false, label="", colorbar = true, size=ps, dpi=300, framestyle=:box, title="Shear 1 std. dev.")
hMRsh2std = Plots.plot(sea064pld1d.t[tind], sea064pld1d.z[tind], zcolor = log10.(sea064pld1d.mr_sh2_std[tind]), seriestype=:scatter, c=:jet, markersize = ms, markerstrokewidth = 0, legend = false, label="", colorbar = true, size=ps, dpi=300, framestyle=:box, title="Shear 2 std. dev.")
...
hTS = Plots.plot(sea064pld1d.saltA[tind], sea064pld1d.ctemp[tind], zcolor = sea064pld1d.sigma0[tind], seriestype=:scatter, c=:jet, markersize = ms, markerstrokewidth = 0, legend = false, label="", clims=lims_sigma0, xlims=lims_salt, ylims=lims_temp, colorbar = false, size=(1000,1000), framestyle=:box, title="CT vs SA")
...
if Plots.backend_name() != :plotly
    ...
    #Plots.savefig(hbb700, figoutdir * "norse_sea064_M" * string(mission, pad=3) * "_" * region * "_FLBBCD_bb700.png")
